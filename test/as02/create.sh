...
then
  $MD5TOOL < /tmp/as02test/as02test.mxf > $1/$3$4.md5s
  $MD5TOOL < /tmp/as02test/media/as02test_v0.mxf >> $1/$3$4.md5s
  $MD5TOOL < /tmp/as02test/media/as02test_a0.mxf >> $1/$3$4.md5s
  $MD5TOOL < /tmp/as02test/media/as02test_a1.mxf >> $1/$3$4.md5s
  RESULT=0
else
  RESULT=1
fi
