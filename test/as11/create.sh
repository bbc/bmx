...
if $BASE_COMMAND --afd 10 -a 16:9 --$4 /tmp/test_in.raw -q 24 --locked true --pcm /tmp/pcm.raw -q 24 --locked true --pcm /tmp/pcm.raw -q 24 --locked true --pcm /tmp/pcm.raw -q 24 --locked true --pcm /tmp/pcm.raw >/dev/null
then
